...
<div class="d-flex flex-column align-items-center bg-secondary shadow w-100 position-sticky">
    ...
    <ul class="nav nav-tabs d-flex flex-row justify-content-center w-100" role="tablist">
...
<div class="d-flex flex-column align-items-center bg-secondary shadow w-100 position-sticky mt-5">
    <div class="d-flex flex-row align-items-center text-dark fw-bold my-1">
        <p class="mx-5">📧 quersin.valentin@gmail.com</p>
        <p class="mx-5">📱 +33 6 33 15 14 92</p>
        <p class="mx-5">🚘 Permis B</p>
    </div>
</div>
